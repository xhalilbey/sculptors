...
const FLOOR: Record<DashboardTheme, string> = {
...
const GROUND: Record<DashboardTheme, string> = {
 ...
 */
export function ProductArt({ shape, tone, className }: { shape: ProductShape; tone: DashboardTheme; className?: string }) {
